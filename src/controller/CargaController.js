...
// Função para listar todas as cargas
async function list(req, res) {
    const response = await Carga.findAll();
    res.json(response);
}

// Função para listar uma carga em específico com o ID
...
// Função para inserir uma novo carga
...
// Função para atualizar os dados de uma carga
